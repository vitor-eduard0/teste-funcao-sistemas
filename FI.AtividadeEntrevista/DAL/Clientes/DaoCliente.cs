...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", new string(cliente.CPF.Where(char.IsDigit).ToArray())));
        ...
        internal bool VerificarExistencia(string CPF, long? id = null)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", new string(CPF.Where(char.IsDigit).ToArray())));
            if (id != null)
                parametros.Add(new System.Data.SqlClient.SqlParameter("ID", id));
